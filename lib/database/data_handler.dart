...
import 'package:swoc_application/models/query.dart';
...
class DataHandler {
  ...
  void addQuery(Query query) async {
    var db = await database;
    var res = await db.insert('Queries', query.toMap());
  }

  void getQuery(String id) async {
    var db = await database;
